...
public class IncorrectDIP {

    public static void main(String[] args) {
        IncorrectDIP incorrectDIP = new IncorrectDIP();
        IterGuideController iterGuideController = incorrectDIP.new IterGuideController();
    }
        ...
        public IterGuideController() {
            this.iterGuideService = new IterGuideServiceImpl(
                    ...
                    new ReportServiceImpl(
                            List.of(
                                    new PdfIterGuideReport(),
                                    new PdfDispatchGuideReport(),
                                    new ExcelIterGuideReport()
                            )
                    ));
        }
